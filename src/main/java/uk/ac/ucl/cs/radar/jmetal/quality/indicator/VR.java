...
public class VR<S extends Solution<?>> extends GenericIndicator<S>{
	private Front front ;
	int nummberOfRuns =0;
	...
	*/
	public VR(String frontFile) throws FileNotFoundException {
		super(frontFile) ;
		if (frontFile == null) {
	...
	*/
	private double vr(List<S> solutionList) throws JMetalException {
